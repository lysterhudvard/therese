...
export const I18N = {
  sv: {
    ...
    credits: {
      ...
      filters: { Alla: "Alla", Film: "Film", TV: "TV", Theater: "Teater", Voice: "Röst" } as Record<string, string>,
    },
    voice: {
      act: "Akt V — Röst",
  ...
  en: {
    ...
    credits: {
      ...
      filters: { Alla: "All", Film: "Film", TV: "TV", Theater: "Theatre", Voice: "Voice" } as Record<string, string>,
    },
    voice: {
      act: "Act V — Voice",

...
const SECTION_PROFILES: Record<string, ImageProfile> = {
  hero: {
    ...
    seoGuideline: "Kritisk för LCP (Largest Contentful Paint). Bilder över 300 KB sänker sajtens initiala laddningshastighet hos Google.",
  },
  bio: {
    name: "Akt II: Biografi (Moods)",
    maxWidth: 1000,
    maxHeight: 1333, // 3:4 portrait
    targetKb: 150,
  ...
  showreel: {
    ...
    maxHeight: 1080,
    targetKb: 200,
    description: "Visas som en fast omslagsbild i videospelaren innan besökaren klickar på play.",

...
export function DashboardBio() {
  ...
  const [paragraph1Sv, setParagraph1Sv] = useState("Therese var senast aktuell i SVT:s dramadokumentär En våldsam kärlek där hon spelade rollen som Victoria, en av de fyra kvinnor vars öden vi fick följa. Serien handlar om våld i nära relationer — en samhällsfråga vi måste prata mer om, belysa dess problematik och börja agera.");
  const [paragraph1En, setParagraph1En] = useState("Therese was most recently seen in SVT's documentary drama En våldsam kärlek where she played the role of Victoria, one of the four women whose fates we follow. The series is about intimate-partner violence — a societal issue we must talk about more, expose, and act on.");

          ...
          >
            {isEnlarged ? (
              <>
                ...
                <div 
                  className="relative w-[90vw] md:w-[86vw] max-w-[1400px] flex flex-col cursor-default"
                  onClick={(e) => e.stopPropagation()} // Prevent close when clicking internal video space/header
                >
                  {/* Header Bar */}

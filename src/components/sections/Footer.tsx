...
export function Footer({ bioData, simple = false }: { bioData?: any; simple?: boolean }) {
  const { lang, t } = useT();
  ...
  return (
    <footer
      ...
      className={
        simple
          ? "relative border-t border-bone/10 bg-black/40 px-6 py-10 md:px-12 overflow-hidden flex flex-col items-center justify-center"
          : "relative border-t border-bone/10 bg-black/40 px-6 py-20 md:px-12 md:py-32 overflow-hidden flex flex-col items-center justify-center min-h-[580px]"
      }
    >
      ...
      <div className={
        simple
          ? "relative w-full max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-2 text-[9px] uppercase tracking-[0.35em] text-bone/60 z-10 text-center"
          : "relative w-full max-w-7xl mx-auto mt-16 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-[9px] uppercase tracking-[0.35em] text-bone/60 z-10 text-left"
      }>
